...
exports.configUpdate = functions.firestore
    ...
    return __generator(this, function (_a) {
        if (context) {
            ...
            request = generateRequest(context.params.deviceId, change.after.data(), false);
            return [2 /*return*/, client.modifyCloudToDeviceConfig(request)];
        }
        else {
...
exports.configUpdateBinary = functions.firestore
    ...
    return __generator(this, function (_a) {
        if (context) {
            console.log(context.params.deviceId);
            request = generateRequest(context.params.deviceId, change.after.data(), true);
            return [2 /*return*/, client.modifyCloudToDeviceConfig(request)];
        }
        else {
            throw (Error("no context from trigger"));
...
function generateRequest(deviceId, configData, isBinary) {
    var formattedName = client.devicePath(process.env.GCLOUD_PROJECT, functions.config().iot.core.region, functions.config().iot.core.registry, deviceId);
    var dataValue;
    if (isBinary) {
